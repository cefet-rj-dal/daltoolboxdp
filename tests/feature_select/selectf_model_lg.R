...
source("daltoolbox/R/sklearn/feature_select/selectf_model_lg.R")
...
# Call Python logistic regression model and feature selection
lg_model <- create_fit_lg_model(iris_train_label, "species_encoded", C=0.1, penalty='l1', solver='liblinear')
