# #####################################################################
# # K-Nearest Neighbors Classifier Testing Script
# # Demonstrates implementation and evaluation of KNN classifier
# #####################################################################
...
# # Model Training
# #--------------------
# # Initialize and train KNN classifier with n_neighbors=1
