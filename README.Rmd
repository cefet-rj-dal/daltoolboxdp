...
<!-- badges: start -->
![GitHub Repo stars](https://img.shields.io/github/stars/cefet-rj-dal/daltoolboxdp?logo=Github)
...
The latest version of DAL Toolbox Data Preprocessing at CRAN is available at:
<https://CRAN.R-project.org/package=daltoolboxdp>
...
You can install the development version of DAL Toolbox Data Preprocesing from GitHub [https://github.com/cefet-rj-dal/daltoolboxdp](https://github.com/cefet-rj-dal/daltoolboxdp) with:
