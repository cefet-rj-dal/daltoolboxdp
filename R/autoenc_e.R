...
#'ae <- autoenc_e(input_size = 20, encoding_size = 5, epochs = 100)
...
#'@import reticulate
#'@export
autoenc_e <- function(input_size, encoding_size, batch_size = 32, epochs = 100L, num_epochs = NULL, learning_rate = 0.001,
