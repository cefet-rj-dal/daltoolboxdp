...
#'@return `cla_mlp` object
#'@examples
#'#See an example of using `cla_mlp` at this
#'#https://github.com/cefet-rj-dal/daltoolboxdp/blob/main/examples/cla_mlp.md
#'@import daltoolbox
#'@export
...
predict.cla_mlp <- function(object, x, ...) {
  ...
  prediction <- mlp_predict(object$model, x)
