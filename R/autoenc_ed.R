...
#'ae <- autoenc_ed(input_size = 20, encoding_size = 5, epochs = 100)
...
#'@import reticulate
#'@export
autoenc_ed <- function(input_size, encoding_size, batch_size = 32, epochs = 100L, num_epochs = NULL, learning_rate = 0.001,
...
fit.autoenc_ed <- function(obj, data, ...) {
  ...
  result <- autoenc_fit(obj$model, data, batch_size=obj$batch_size, num_epochs = obj$epochs, learning_rate = obj$learning_rate,
