...
#'ae <- autoenc_denoise_e(input_size = 20, encoding_size = 5, noise_factor = 0.2, epochs = 100)
...
#'@import reticulate
#'@export
autoenc_denoise_e <- function(input_size, encoding_size, batch_size = 32, epochs = 100L, num_epochs = NULL, learning_rate = 0.001, noise_factor=0.3,
